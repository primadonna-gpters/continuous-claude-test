...
const WORD_LIST = [
    ...
    'apple', 'apply', 'arena', 'argue', 'arise', 'armor', 'aroma', 'array', 'arrow', 'asset',
    ...
    'build', 'built', 'bunch', 'burst', 'buyer', 'cabin', 'cable', 'camel', 'cameo', 'canal',
    ...
    'forth', 'forty', 'forum', 'foyer', 'found', 'frame', 'frank', 'fraud', 'freak', 'fresh',
