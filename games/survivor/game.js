...
// Stage selection state (constants loaded from modules/constants.js)
let selectedStage = 'madForest';
let currentStageModifiers = {};

// Character selection state (constants loaded from modules/constants.js)
...
// Enemy types and wave events are loaded from modules/constants.js
...
// Camera for world-space rendering (WORLD_SIZE loaded from modules/constants.js)
let camera = { x: 0, y: 0 };
